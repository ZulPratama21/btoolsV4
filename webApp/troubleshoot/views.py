...
@login_required(redirect_field_name='next', login_url='/login')
def configWifi(request, deviceId):
    ...
    if request.method == 'POST':
        ...
        if onuType == 'F670L' or onuType == 'F679':
            result5 = zte1.setWifi(deviceId, '5.8', ssid5, passWifi5)
            result2 = zte1.setWifi(deviceId, '2.4', ssid2, passWifi2)

        elif onuType == 'F609' or onuType == 'F660':
            result2 = zte2.setWifi(deviceId, '2.4', ssid2, passWifi2)

        elif onuVer == 'FD514GD-R460':
            result5 = cdt1.setWifi(deviceId, '5.8', ssid5, passWifi5)
            result2 = cdt1.setWifi(deviceId, '2.4', ssid2, passWifi2)

        elif onuVer == 'FD514GS1-R550':
            result5 = cdt2.setWifi(deviceId, '5.8', ssid5, passWifi5)
            result2 = cdt2.setWifi(deviceId, '2.4', ssid2, passWifi2)

        elif onuVer == 'FD512XW-R460':
            result2 = cdt3.setWifi(deviceId, '2.4', ssid2, passWifi2)
