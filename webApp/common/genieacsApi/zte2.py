# Supported device: F609, F623, F660 "Hanya bisa menampilkan SSID saja"
...
def getData(clientIp):
    ...
    query = json.dumps({
        "InternetGatewayDevice.WANDevice.1.WANConnectionDevice.1.WANPPPConnection.2.ExternalIPAddress": clientIp
    })
    ...
    try:
        ...
        if responseKeypassphrase2.status_code == 200:
            ...
            keypassphrase5 = keypassphraseData5[0]['InternetGatewayDevice']['LANDevice']['1']['WLANConfiguration']['1']['PreSharedKey']['1']['KeyPassphrase']['_value']
