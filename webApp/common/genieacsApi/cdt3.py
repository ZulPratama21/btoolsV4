...
def getData(clientIp):
    ...
    try:
        ...
        if responseSsid2.status_code == 200:
            ssidData5 = responseSsid2.json()
            ssid2 = ssidData5[0]['InternetGatewayDevice']['LANDevice']['1']['WLANConfiguration']['1']['SSID']['_value']
