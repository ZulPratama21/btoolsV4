# Supported device: FD514GS1-R550
...
def getData(deviceId):
    ...
    projectionSsid2 = "InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.SSID._value"
    projectionKeypassphrase5 = "InternetGatewayDevice.LANDevice.1.WLANConfiguration.1.X_CMS_KeyPassphrase._value"
    projectionKeypassphrase2 = "InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.X_CMS_KeyPassphrase._value"
    ...
    try:
        ...
        if responseSsid2.status_code == 200:
            ...
            ssid2 = ssidData2[0]['InternetGatewayDevice']['LANDevice']['1']['WLANConfiguration']['5']['SSID']['_value']
    ...
    try:
        ...
        if responseKeypassphrase2.status_code == 200:
            ...
            keypassphrase5 = keypassphraseData5[0]['InternetGatewayDevice']['LANDevice']['1']['WLANConfiguration']['5']['X_CMS_KeyPassphrase']['_value']
...
def setWifi(deviceId, band, ssid, passWifi):
    ...
    if band == '5.8':
        ...
        paramPassWifi = 'InternetGatewayDevice.LANDevice.1.WLANConfiguration.5.X_CMS_KeyPassphrase'
